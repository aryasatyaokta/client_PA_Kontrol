...
export default function ResultStruk3() {
    ...
    async function onRestart(){
      await axios.delete(`https://server-pa-kontrol.vercel.app/api/resultstruk3?name=${sessionStorage.getItem('name')}`)
      ...
      <Sidebar/>
        ...
        <div className="p-4  mt-14">
          <div className="gap-4 mb-4 font-[Poppins]">
            <div className="col-span-2 justify-center items-center rounded-lg bg-gray-100 h-[600px] dark:bg-gray-800">
